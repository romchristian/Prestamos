...
public class TransaccionDepositoEfectivo extends TransaccionBancaria{
    ...
    public TransaccionDepositoEfectivo(String codRef,String comprobante, CuentaBancaria cuentaBancaria, Moneda moneda, Cotizacion cotizacion, String usuario, BigDecimal monto) {
        super(codRef, "Deposito Efectivo comprobate: " +comprobante, new Date(), cuentaBancaria, TipoTransaccion.ENTRADA, moneda, cotizacion, usuario, monto);
